...
abstract class Module(
    ...
    val taskFactory: (Module, Session, TaskQuestion, List<TaskAnswer>, Int, ModuleConfig, Triple<Int, Any, Boolean>?) -> ModuleTask,
    ...
    abstract fun makeTask(taskID: Int, config: ModuleConfig, session: Session): ModuleTask
    ...
    fun deserializeTask(
        ...
        return taskFactory(this, session, questionFactory(question), answersList, taskID, config, attempts.lastOrNull())
    }
...
abstract class TaskAttempt(
    ...
    val userAnswer: TaskUserAnswer = task.getModule().userAnswerFactory(this, loadedUserAnswer)
    private val judgment: TaskJudgment = task.getModule().judgmentFactory(this, loadedJudgment)
